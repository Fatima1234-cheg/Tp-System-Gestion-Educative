...
public class DepartementsController {
    ...
    public static void showDepartements(){
        for (Departement departement : DB.departements) {
            ...
            if (! Main.isNull(departement.getChef())) {
                System.out.print(" | Chef : " + departement.getChef() + " " + departement.getChef());
            }
            System.out.println("");
        }
    ...
    public static void createDepartement(){
        ...
        DepartementServices.addDept(intitule, EnseignantsServices.getEnsById(id));
    ...
    public static void editDepartement(){
        ...
        DepartementServices.updateDept(id, intitule, EnseignantsServices.getEnsById(idEns));
